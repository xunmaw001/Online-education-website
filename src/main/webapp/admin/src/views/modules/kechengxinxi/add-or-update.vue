<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="课件资源" prop="kejianziyuan">
          <file-upload
          tip="点击上传课件资源"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.kejianziyuan?ruleForm.kejianziyuan:''"
          @change="kejianziyuanUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.kejianziyuan" label="课件资源" prop="kejianziyuan">
            <el-button type="text" size="small" @click="download(ruleForm.kejianziyuan)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengxiangqing = true;
          ...
          if(o=='kejianziyuan'){
            this.ruleForm.kejianziyuan = obj[o];
	    this.ro.kejianziyuan = true;
            continue;
          }
          if(o=='jiaoshigonghao'){
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../ssmn5138/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    kejianziyuanUploadChange(fileUrls) {
	this.ruleForm.kejianziyuan = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
